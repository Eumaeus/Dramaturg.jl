...
Using `scripts/config-antigone.toml` as a starting point.

cd PATH/TO/Dramaturg/

[Start Docker]

cp scripts/Configs_Sophocles/config-sophocles-antigone.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Sophocles_Antigone/Sophocles_Antigone_beta_vocabulary.txt morph/source-data/words.txt
