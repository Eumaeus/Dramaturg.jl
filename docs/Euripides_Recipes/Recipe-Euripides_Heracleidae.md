...
cp scripts/Configs_Euripides/config-euripides_heracleidae.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Heracleidae/Euripides_Heracleidae_beta_vocabulary.txt morph/source-data/words.txt
