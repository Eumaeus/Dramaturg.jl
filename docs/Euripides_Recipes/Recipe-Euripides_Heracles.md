...
cp scripts/Configs_Euripides/config-euripides_heracles.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Heracles/Euripides_Heracles_beta_vocabulary.txt morph/source-data/words.txt
