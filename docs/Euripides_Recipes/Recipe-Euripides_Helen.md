...
cp scripts/Configs_Euripides/config-euripides_helen.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Helen/Euripides_Helen_beta_vocabulary.txt morph/source-data/words.txt
