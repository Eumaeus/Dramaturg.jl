...
cp scripts/Configs_Euripides/config-euripides_trojan.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Trojan/Euripides_Trojan_beta_vocabulary.txt morph/source-data/words.txt
