...
cp scripts/Configs_Euripides/config-euripides_medea.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Medea/Euripides_Medea_beta_vocabulary.txt morph/source-data/words.txt
