...
cp scripts/Configs_Euripides/config-euripides_orestes.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Orestes/Euripides_Orestes_beta_vocabulary.txt morph/source-data/words.txt
