...
cp scripts/Configs_Euripides/config-euripides_taurians.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Taurians/Euripides_Taurians_beta_vocabulary.txt morph/source-data/words.txt
