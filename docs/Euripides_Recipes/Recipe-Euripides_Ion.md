...
cp scripts/Configs_Euripides/config-euripides_ion.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides_Ion/Euripides_Ion_beta_vocabulary.txt morph/source-data/words.txt
