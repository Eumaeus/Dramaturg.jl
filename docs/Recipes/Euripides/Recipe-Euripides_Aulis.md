...
cp scripts/Configs/Euripides/config-euripides_aulis.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides/Aulis/Euripides_Aulis_beta_vocabulary.txt morph/source-data/words.txt
