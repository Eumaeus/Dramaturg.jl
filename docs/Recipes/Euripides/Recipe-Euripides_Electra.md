...
cp scripts/Configs/Euripides/config-euripides_electra.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides/Electra/Euripides_Electra_beta_vocabulary.txt morph/source-data/words.txt
