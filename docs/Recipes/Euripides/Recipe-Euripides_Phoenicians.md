...
cp scripts/Configs/Euripides/config-euripides_phoenician.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides/Phoenician/Euripides_Phoenician_beta_vocabulary.txt morph/source-data/words.txt
