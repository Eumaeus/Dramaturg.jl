...
cp scripts/Configs/Euripides/config-euripides_cyclops.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides/Cyclops/Euripides_Cyclops_beta_vocabulary.txt morph/source-data/words.txt
