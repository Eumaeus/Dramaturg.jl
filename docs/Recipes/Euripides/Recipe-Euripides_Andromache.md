...
cp scripts/Configs/Euripides/config-euripides_andromache.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides/Andromache/Euripides_Andromache_beta_vocabulary.txt morph/source-data/words.txt
