...
cp scripts/Configs/Euripides/config-euripides_suppliants.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Euripides/Suppliants/Euripides_Suppliants_beta_vocabulary.txt morph/source-data/words.txt
