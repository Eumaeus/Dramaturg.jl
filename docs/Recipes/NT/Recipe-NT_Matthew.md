...
Using `scripts/config-nt-matthew.toml` as a starting point.
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/nt-matthew-analysis.txt 2> morph/output/nt-matthew-errors.log
