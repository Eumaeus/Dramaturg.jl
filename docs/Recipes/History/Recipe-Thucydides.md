...
Using `scripts/Configs/History/config-thucydides.toml` as a starting point.

cd PATH/TO/Dramaturg/

[Start Docker]

cp scripts/Configs/History/config-thucydides.toml scripts/config.toml

julia --julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/History/Thucydides/Thucydides_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/thucydides-analysis.txt 2> morph/output/thucydides-errors.log
