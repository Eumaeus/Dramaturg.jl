# Recipe: Aristophanes' *Ecclesiazousae*

Using `scripts/Configs/Aristophanes/config-ecclesiazousae.toml` as a starting point.

cd PATH/TO/Dramaturg/

[Start Docker]

cp scripts/Configs/Aristophanes/config-ecclesiazousae.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Aristophanes/Ecclesiazousae/Aristophanes_Ecclesiazousae_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/aristophanes-ecclesiazousae-analysis.txt 2> morph/output/aristophanes-ecclesiazousae-errors.log
