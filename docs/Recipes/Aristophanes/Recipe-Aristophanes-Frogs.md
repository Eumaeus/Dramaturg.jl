...
Using `scripts/Configs/Aristophanes/config-frogs.toml` as a starting point.
...
cp data/vocabulary/Aristophanes/Frogs/Aristophanes_Frogs_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/aristophanes-frogs-analysis.txt 2> morph/output/aristophanes-frogs-errors.log
