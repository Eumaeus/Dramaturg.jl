...
Using `scripts/Configs/Sophocles/config-sophocles-oedipus.toml` as a starting point.

cd PATH/TO/Dramaturg/

[Start Docker]

cp scripts/Configs/Sophocles/config-sophocles-oedipus.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Sophocles/Oedipus/Oedipus_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/oedipus-analysis.txt 2> morph/output/oedipus-errors.log
