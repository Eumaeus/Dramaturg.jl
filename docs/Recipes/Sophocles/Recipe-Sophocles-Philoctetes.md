# Recipe: Sophocles' *Philoctetes*

Using `scripts/Configs/Sophocles/config-philoctetes.toml` as a starting point.
...
cp data/vocabulary/Sophocles/Philoctetes/Philoctetes_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/philoctetes-analysis.txt 2> morph/output/philoctetes-errors.log
