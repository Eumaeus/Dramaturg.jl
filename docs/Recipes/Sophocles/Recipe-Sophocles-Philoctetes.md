...
Using `scripts/config-philoctetes.toml` as a starting point.

cd PATH/TO/Dramaturg/

[Start Docker]

cp scripts/Configs_Sophocles/config-sophocles-philoctetes.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Sophocles_Philoctetes/Sophocles_Philoctetes_beta_vocabulary.txt morph/source-data/words.txt
