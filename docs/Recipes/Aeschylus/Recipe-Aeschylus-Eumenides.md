...
cp scripts/Configs/Aeschylus/config-eumenides.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Aeschylus/Eumenides/Aeschylus_Eumenides_beta_vocabulary.txt morph/source-data/words.txt
