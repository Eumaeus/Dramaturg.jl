...
cp scripts/Configs/Aeschylus/config-persians.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Aeschylus/Persians/Aeschylus_Persians_beta_vocabulary.txt morph/source-data/words.txt
