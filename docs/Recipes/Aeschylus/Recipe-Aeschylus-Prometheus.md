...
cp scripts/Configs/Aeschylus/config-prometheus.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Aeschylus/Prometheus/Aeschylus_Prometheus_beta_vocabulary.txt morph/source-data/words.txt
