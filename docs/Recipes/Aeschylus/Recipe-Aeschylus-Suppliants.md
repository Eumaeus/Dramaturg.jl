...
cp scripts/Configs/Aeschylus/config-suppliants.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Aeschylus/Suppliants/Aeschylus_Suppliants_beta_vocabulary.txt morph/source-data/words.txt
