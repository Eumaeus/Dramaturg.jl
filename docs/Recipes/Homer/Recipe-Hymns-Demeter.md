...
Using `scripts/Configs/Homer/config-hymn-2-Demeter.toml` as a starting point.
...
cp data/vocabulary/Homer/2_Demeter/2_Demeter_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/homer-hymn-2-demeter-analysis.txt 2> morph/output/homer-hymn-2-demeter_parse_errors.log
