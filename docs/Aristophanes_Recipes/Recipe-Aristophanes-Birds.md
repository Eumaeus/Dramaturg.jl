...
Using `scripts/config-birds.toml` as a starting point.
...
cp data/vocabulary/Aristophanes_Birds/Aristophanes_Birds_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/birds-analysis.txt 2> morph/output/birds-errors.log
