...
cp scripts/Configs_Aristophanes/config-frogs.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Aristophanes_Frogs/Aristophanes_Frogs_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/frogs-analysis.txt 2> morph/output/frogs-errors.log
