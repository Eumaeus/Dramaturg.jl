...
Using `scripts/config-acharnians.toml` as a starting point.
...
cp data/vocabulary/Aristophanes_Acharnians/Aristophanes_Acharnians_beta_vocabulary.txt morph/source-data/words.txt
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/acharnians-analysis.txt 2> morph/output/acharnians-errors.log
