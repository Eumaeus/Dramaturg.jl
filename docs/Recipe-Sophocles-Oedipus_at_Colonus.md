...
cp scripts/config-sophocles-colonus.toml scripts/config.toml
...
MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/colonus-analysis.txt 2> morph/output/colonus-errors.log
