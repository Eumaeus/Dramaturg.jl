...
[In the Docker VM terminal] `MORPHLIB=stemlib bin/cruncher -S < morph/source-data/words.txt > morph/output/demeter-analysis.txt 2> morph/output/demeter-errors.log`
