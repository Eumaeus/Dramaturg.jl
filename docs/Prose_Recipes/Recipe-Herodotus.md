...
cp scripts/Configs_History/config-herodotus.toml scripts/config.toml

julia --project=. scripts/tokenize_cex.jl

cp data/vocabulary/Herodotus/Herodotus_beta_vocabulary.txt morph/source-data/words.txt
